const CACHE='one-more-door-v2';
const ASSETS=['./','./index.html','./styles.css','./v2.css','./core.js','./flow.js','./mechanics.js','./progression.js','./render.js','./v2.js','./boot.js','./manifest.webmanifest','./icons/icon.svg'];
