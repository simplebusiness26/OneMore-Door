const CACHE='one-more-door-v1';
const ASSETS=['./','./index.html','./styles.css','./core.js','./flow.js','./mechanics.js','./progression.js','./render.js','./boot.js','./manifest.webmanifest','./icons/icon.svg'];
