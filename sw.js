const CACHE='one-more-door-v3';
const ASSETS=['./','./index.html','./styles.css','./v2.css','./missions.css','./core.js','./flow.js','./mechanics.js','./progression.js','./render.js','./v2.js','./v2-fixes.js','./missions.js','./boot.js','./manifest.webmanifest','./icons/icon.svg'];
